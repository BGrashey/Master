...
sn_cube_path = "/data/hetdex/u/bgrashey/cubes/injected_4.zarr"
fits_header_path = "/data/hetdex/u/bgrashey/cubes/ssa22_fullfp_stack.fits"
output_catalog_path = "/data/hetdex/u/bgrashey/data_/completeness_cat_04.fits"
sn_threshold = 0.5
linking_length = 2


sn_cube = da.from_zarr(sn_cube_path, component="PRIMARY") # component="PRIMARY"
